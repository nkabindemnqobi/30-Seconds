export default class TriviaLobby extends HTMLElement {
    ...
    copyLobbyCode() {
      ...
      navigator.clipboard.writeText(lobbyCode)
        .then(() => {
          ...
          // Provide visual feedback that copying succeeded
    ...
    render() {
      ...
      title.textContent = this.lobbyData.data.lobby_name;
      ...
      lobbyCode.textContent = `Lobby Code: ${this.lobbyData.data.join_code}`;
      ...
      footer.textContent = `Created on ${new Date(this.lobbyData.data.started_datetime).toLocaleString()}`;
